  ...
  linear: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M9 4h6m-3 0v12.5a3.5 3.5 0 1 0 7 0v-.056"
      />
      <path
        stroke="currentColor"
        strokeWidth="1.5"
  ...
  broken: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M9 4h6m5.8 6a1.2 1.2 0 0 1 1.2 1.2V13a3 3 0 1 1-6 0v-1.8a1.2 1.2 0 0 1 1.2-1.2M12 4v3m0 9.5a3.5 3.5 0 1 0 7 0v-.056m-7 .056a3.5 3.5 0 1 1-7 0v-.056m7 .056V11"
      />
      <path
        stroke="currentColor"
        strokeWidth="1.5"
...
function Chandelier({ variant = "linear", ...props }: IconProps) {
