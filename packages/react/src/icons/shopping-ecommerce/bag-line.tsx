...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="m15 11 1 6m-7-6-1 6M9 6V5a3 3 0 1 1 6 0v1"
      />
    </>
  ),
  bold: (
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M9.75 5a2.25 2.25 0 0 1 4.5 0v1c.566 0 1.062.002 1.5.015V5a3.75 3.75 0 1 0-7.5 0v1.015C8.688 6.002 9.184 6 9.75 6zm-1.49 5.877a.75.75 0 1 1 1.48.246l-1 6a.75.75 0 1 1-1.48-.246zm6.617-.617a.75.75 0 0 1 .863.617l1 6a.75.75 0 0 1-1.48.246l-1-6a.75.75 0 0 1 .617-.863"
      />
    </>
  ),
  "line-duotone": (
...
export function BagLine({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

BagLine.displayName = "IconBagLine";

export const IconBagLine = BagLine;
export const BagLineIcon = BagLine;
