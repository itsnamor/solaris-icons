...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M9.5 10h5M12 12.5v-5"/>
		</>
	),
	bold: (
	...
	broken: (
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M9.5 10h5M12 12.5v-5m-7 7.716c-.647-1.654-1-3.415-1-5.073C4 5.646 7.582 2 12 2s8 3.646 8 8.143c0 4.462-2.553 9.67-6.537 11.531a3.45 3.45 0 0 1-2.926 0C9.265 21.08 8.138 20.144 7.194 19"/>
	),
	outline: (
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M12.75 7.5a.75.75 0 0 0-1.5 0v1.75H9.5a.75.75 0 0 0 0 1.5h1.75v1.75a.75.75 0 0 0 1.5 0v-1.75h1.75a.75.75 0 0 0 0-1.5h-1.75z"/>
		</>
	),
	"line-duotone": (
...
export function MapPinPlus({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconMapPinPlus = MapPinPlus;
