...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M10.5 10h3M12 11.5v-3"/>
		</>
	),
	bold: (
		<><path fill="currentColor" fillRule="evenodd" d="M12 7.75a.75.75 0 0 1 .75.75v.75h.75a.75.75 0 0 1 0 1.5h-.75v.75a.75.75 0 0 1-1.5 0v-.75h-.75a.75.75 0 0 1 0-1.5h.75V8.5a.75.75 0 0 1 .75-.75" clipRule="evenodd"/>
	...
	broken: (
		<><circle cx="12" cy="10" r="4" stroke="currentColor" strokeWidth="1.5"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M10.5 10h3M12 11.5v-3m-7 6.716c-.647-1.654-1-3.415-1-5.073C4 5.646 7.582 2 12 2s8 3.646 8 8.143c0 4.462-2.553 9.67-6.537 11.531a3.45 3.45 0 0 1-2.926 0C9.265 21.08 8.138 20.144 7.194 19"/>
		</>
	),
	outline: (
	...
	"bold-duotone": (
		<><path fill="currentColor" fillRule="evenodd" d="M12 2c-4.418 0-8 3.646-8 8.143 0 4.462 2.553 9.67 6.537 11.531a3.45 3.45 0 0 0 2.926 0C17.447 19.812 20 14.606 20 10.144 20 5.645 16.418 2 12 2m0 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8" clipRule="evenodd" opacity=".5"/>
		<path fill="currentColor" fillRule="evenodd" d="M12 14a4 4 0 1 0 0-8 4 4 0 0 0 0 8m.75-5.5a.75.75 0 0 0-1.5 0v.75h-.75a.75.75 0 0 0 0 1.5h.75v.75a.75.75 0 0 0 1.5 0v-.75h.75a.75.75 0 0 0 0-1.5h-.75z" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
...
export function MapPinCirclePlus({ variant = "linear", ...props }: IconProps) {
