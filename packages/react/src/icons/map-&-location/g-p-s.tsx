...
const VARIANTS = {
  ...
  broken: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M12.5 14.959q-.245.04-.5.041a3 3 0 1 1 2.959-2.5M2 12h2m16 0h2M12 4V2m0 20v-2"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M12 8.512a3.488 3.488 0 1 0 0 6.976 3.488 3.488 0 0 0 0-6.976M12.75 2a.75.75 0 0 0-1.5 0v2.035a8 8 0 0 1 1.5 0zm7.215 10.75a8 8 0 0 0 0-1.5H22a.75.75 0 0 1 0 1.5zm-8.715 7.215a8 8 0 0 0 1.5 0V22a.75.75 0 0 1-1.5 0zM4.035 11.25a8 8 0 0 0 0 1.5H2a.75.75 0 0 1 0-1.5z"
      />
    </>
  ),
  "line-duotone": (
...
function GPS({ variant = "linear", ...props }: IconProps) {
