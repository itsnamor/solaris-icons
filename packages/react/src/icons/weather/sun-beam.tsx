...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M12 2v1m0 18v1m10-10h-1M3 12H2m17.07-7.07-.392.392M5.322 18.678l-.393.393m14.141-.001-.392-.392M5.322 5.322l-.393-.393"
      />
    </>
  ),
  bold: (
  ...
  broken: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="M12 2v1m0 18v1m10-10h-1M3 12H2m17.07-7.07-.392.392M5.322 18.678l-.393.393m14.141-.001-.392-.392M5.322 5.322l-.393-.393M6.341 10A6 6 0 1 0 10 6.341"
    />
  ),
  outline: (
    <path
  ...
  "line-duotone": (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M12 2v1m0 18v1m10-10h-1M3 12H2"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.5"
        d="m19.07 4.93-.392.392M5.322 18.678l-.393.393m14.141-.001-.392-.392M5.322 5.322l-.393-.393"
        opacity=".5"
      />
    </>
  ),
...
SunBeam.displayName = "IconSunBeam";
