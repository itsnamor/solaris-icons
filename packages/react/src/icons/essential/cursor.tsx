...
const VARIANTS = {
  ...
  outline: (
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m10.317 4.626 5.567 2.051c.77.284 1.426.525 1.902.785.498.273.97.656 1.112 1.302s-.126 1.192-.464 1.648c-.323.436-.818.93-1.398 1.51l-.714.714 3.425 3.424c.19.19.358.359.489.509.139.159.271.337.363.558a2 2 0 0 1 0 1.52 2 2 0 0 1-.363.559c-.131.15-.3.318-.49.508l-.032.033c-.19.19-.358.358-.508.489a2 2 0 0 1-.558.363 2 2 0 0 1-1.522 0 2 2 0 0 1-.558-.363c-.15-.131-.318-.3-.508-.49l-3.424-3.424-.714.714c-.58.58-1.074 1.075-1.51 1.398-.456.338-1.002.606-1.648.464s-1.03-.614-1.302-1.112c-.26-.476-.502-1.132-.785-1.902l-2.051-5.567c-.581-1.576-1.046-2.84-1.253-3.813-.206-.971-.218-1.937.488-2.643s1.672-.694 2.643-.488c.973.207 2.236.672 3.813 1.253m-4.124.215c-.868-.185-1.137-.053-1.271.08-.134.135-.266.404-.082 1.272.182.854.607 2.015 1.216 3.668l2.008 5.45c.31.84.514 1.39.714 1.755.188.344.286.363.306.367h.004c.02.006.116.03.43-.204.336-.249.752-.662 1.385-1.295l1.203-1.203a.75.75 0 0 1 1.06 0l3.939 3.939c.21.21.343.342.45.435a.6.6 0 0 0 .146.108c.119.05.253.05.373 0a.6.6 0 0 0 .146-.108c.106-.093.238-.224.45-.435.21-.212.342-.344.435-.45a.6.6 0 0 0 .108-.146.5.5 0 0 0 0-.373.6.6 0 0 0-.108-.146 10 10 0 0 0-.436-.45l-3.938-3.939a.75.75 0 0 1 0-1.06l1.203-1.203c.633-.633 1.046-1.049 1.295-1.384.233-.315.21-.411.205-.431v-.002l-.001-.002c-.004-.02-.023-.118-.367-.306-.366-.2-.915-.404-1.756-.714L9.861 6.057c-1.653-.61-2.814-1.035-3.668-1.216"
      clipRule="evenodd"
    />
  ),
  "bold-duotone": (
    <>
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="m11.433 16.464 1.203-1.202 2.626-2.626 1.202-1.203c1.232-1.23 1.847-1.846 1.702-2.508s-.963-.963-2.596-1.565l-5.45-2.007C6.861 4.152 5.232 3.55 4.392 4.39s-.24 2.47.962 5.73l2.006 5.45c.602 1.633.903 2.45 1.565 2.596s1.277-.47 2.508-1.702"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
  ...
  "line-duotone": (
    <>
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="m12.636 15.262-1.203 1.202c-1.23 1.232-1.846 1.847-2.508 1.702s-.963-.963-1.565-2.596l-2.007-5.45C4.152 6.861 3.55 5.232 4.39 4.392s2.47-.24 5.73.962l5.45 2.006c1.633.602 2.45.903 2.596 1.565s-.47 1.277-1.702 2.508l-1.202 1.203"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
