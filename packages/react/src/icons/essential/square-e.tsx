...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M15 7h-5a1 1 0 0 0-1 1v4m6 5h-5a1 1 0 0 1-1-1v-4m0 0h6"/>
		</>
	),
	bold: (
	...
	outline: (
		<><path fill="currentColor" d="M10 6.25A1.75 1.75 0 0 0 8.25 8v8c0 .966.784 1.75 1.75 1.75h5a.75.75 0 0 0 0-1.5h-5a.25.25 0 0 1-.25-.25v-3.25H15a.75.75 0 0 0 0-1.5H9.75V8a.25.25 0 0 1 .25-.25h5a.75.75 0 0 0 0-1.5z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M8.25 8c0-.966.784-1.75 1.75-1.75h5a.75.75 0 0 1 0 1.5h-5a.25.25 0 0 0-.25.25v3.25H15a.75.75 0 0 1 0 1.5H9.75V16c0 .138.112.25.25.25h5a.75.75 0 0 1 0 1.5h-5A1.75 1.75 0 0 1 8.25 16z"/>
		</>
	),
	"line-duotone": (
...
export const IconSquareE = SquareE;
export const SquareEIcon = SquareE;
