...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        stroke="currentColor"
        strokeWidth="1.5"
        d="m15 9 4-4M5 19l4-4m0-6L5 5m14 14-4-4"
      />
    </>
  ),
  bold: (
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="m5.48 19.582 4.272-4.273a4 4 0 0 1-1.06-1.06L4.417 18.52q.492.57 1.061 1.06M4.418 5.479l4.273 4.273a4 4 0 0 1 1.06-1.06L5.48 4.417q-.57.492-1.06 1.061m9.828 3.213 4.273-4.273q.57.492 1.06 1.061L15.31 9.752a4 4 0 0 0-1.06-1.06m5.332 9.828-4.273-4.272a4 4 0 0 1-1.06 1.06l4.272 4.273q.57-.49 1.06-1.06"
      />
    </>
  ),
  "line-duotone": (
...
function Lifebuoy({ variant = "linear", ...props }: IconProps) {
