...
const VARIANTS = {
  ...
  outline: (
    <>
      <path
        fill="currentColor"
        d="M12 7.75c-.621 0-1.125.504-1.125 1.125a.75.75 0 0 1-1.5 0 2.625 2.625 0 1 1 3.96 2.26 1.9 1.9 0 0 0-.465.369c-.102.12-.12.2-.12.246V13a.75.75 0 0 1-1.5 0v-1.25c0-.506.222-.916.477-1.217.252-.297.566-.524.845-.689A1.124 1.124 0 0 0 12 7.75M12 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
...
function SquareQuestionMark({ variant = "linear", ...props }: IconProps) {
