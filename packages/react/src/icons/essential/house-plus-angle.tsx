...
const VARIANTS = {
  ...
  outline: (
    <>
      <path
        fill="currentColor"
        d="M12.75 10a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 1 0 0 1.5h2.25V16a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export function HousePlusAngle({ variant = "linear", ...props }: IconProps) {
