...
const VARIANTS = {
	...
	outline: (
		<><path fill="currentColor" d="M13 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0m-1 9.75a.75.75 0 0 0 .75-.75v-6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75"/>
...
export function SquareILowercase({ variant = "linear", ...props }: IconProps) {
