...
const VARIANTS = {
  ...
  outline: (
    <>
      <path
        fill="currentColor"
        d="M9.447 15.398a.75.75 0 1 0-.894 1.204A5.77 5.77 0 0 0 12 17.75a5.77 5.77 0 0 0 3.447-1.148.75.75 0 1 0-.894-1.204A4.27 4.27 0 0 1 12 16.25a4.27 4.27 0 0 1-2.553-.852"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export function HouseSmile({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

HouseSmile.displayName = "IconHouseSmile";

export const IconHouseSmile = HouseSmile;
export const HouseSmileIcon = HouseSmile;
