  ...
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M7.5 19c.655 1.748 2.422 3 4.5 3q.367 0 .72-.05M16.5 19a4.5 4.5 0 0 1-1.302 1.84M9 2.674A7 7 0 0 1 19 9v.704c0 .845.25 1.671.719 2.374l1.148 1.723a2.77 2.77 0 0 1-1.576 4.21 27.7 27.7 0 0 1-14.582 0 2.77 2.77 0 0 1-1.576-4.21l1.148-1.723a4.3 4.3 0 0 0 .72-2.374V9c0-1.074.24-2.09.673-3"
      />
    </>
  ),
  outline: (
...
export function BellZ({ variant = "linear", ...props }: IconProps) {
