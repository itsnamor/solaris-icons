...
const VARIANTS = {
  linear: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="M22 10.5V12c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2h1.5M7 14h9m-9 3.5h6M22 2l-5 5m0-5 5 5"
    />
  ),
  bold: (
    <>
  ...
  broken: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="M7 14h9m-9 3.5h6M22 2l-5 5m0-5 5 5M2 12c0 4.714 0 7.071 1.464 8.535C4.93 22 7.286 22 12 22s7.071 0 8.535-1.465C22 19.072 22 16.714 22 12v-1.5M13.5 2H12C7.286 2 4.929 2 3.464 3.464c-.973.974-1.3 2.343-1.409 4.536"
    />
  ),
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M7 13.25a.75.75 0 0 0 0 1.5h9a.75.75 0 0 0 0-1.5zm-.75 4.25a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75"
      />
    </>
  ),
  "bold-duotone": (
    <>
      <path
        fill="currentColor"
        d="M7 13.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
  ...
  "line-duotone": (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M7 14h9m-9 3.5h6M22 2l-5 5m0-5 5 5"
      />
    </>
  ),
};
