...
const VARIANTS = {
  ...
  bold: (
    <>
      <path
        fill="currentColor"
        d="M8.75 11.25H12a2.25 2.25 0 0 0 0-4.5H9.522a.77.77 0 0 0-.772.772zm0 1.5v4.073c0 .236.19.427.426.427H13a2.25 2.25 0 0 0 0-4.5z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
...
function CircleB({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

CircleB.displayName = "IconCircleB";
