...
const VARIANTS = {
  linear: (
    <path
      ...
      strokeWidth="1.5"
      d="M3 15c0 2.828 0 4.243.879 5.121C4.757 21 6.172 21 9 21h6c2.828 0 4.243 0 5.121-.879C21 19.243 21 17.828 21 15m-9 1V3m0 0 4 4.375M12 3 8 7.375"
    />
  ),
  bold: (
    <>
...
function ArrowUpFromBracket({ variant = "linear", ...props }: IconProps) {
