...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10.5 13.5h-3m3 0v3m0-3L7 17m6.5-6.5h3m-3 0v-3m0 3L17 7m-6.5 3.5h-3m3 0v-3m0 3L7 7m6.5 6.5h3m-3 0v3m0-3L17 17"/>
...
export function SquareFourArrowsIn({ variant = "linear", ...props }: IconProps) {
