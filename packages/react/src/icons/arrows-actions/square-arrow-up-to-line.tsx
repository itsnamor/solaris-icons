...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 17v-7m0 0 3 3m-3-3-3 3"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M16 7H8"/>
	...
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 17v-7m0 0 3 3m-3-3-3 3"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M16 7H8m14 5c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536"/>
		</>
	),
	outline: (
		<><path fill="currentColor" d="M7.25 7c0 .414.336.75.75.75h8a.75.75 0 0 0 0-1.5H8a.75.75 0 0 0-.75.75M12 17.75a.75.75 0 0 0 .75-.75v-5.19l1.72 1.72a.75.75 0 1 0 1.06-1.06l-3-3a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06l1.72-1.72V17c0 .414.336.75.75.75"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M8 7.75a.75.75 0 0 1 0-1.5h8a.75.75 0 0 1 0 1.5zM12.75 17a.75.75 0 0 1-1.5 0v-5.19l-1.72 1.72a.75.75 0 0 1-1.06-1.06l3-3a.75.75 0 0 1 1.06 0l3 3a.75.75 0 1 1-1.06 1.06l-1.72-1.72z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 17v-7m0 0 3 3m-3-3-3 3"/>
...
export function SquareArrowUpToLine({ variant = "linear", ...props }: IconProps) {
