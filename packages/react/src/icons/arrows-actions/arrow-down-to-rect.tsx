...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 2v13m0 0-3-3.5m3 3.5 3-3.5"/>
		</>
	),
	bold: (
...
export function ArrowDownToRect({ variant = "linear", ...props }: IconProps) {
