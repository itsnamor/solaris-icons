...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17 7h-3m3 0v3m0-3-3.5 3.5M7 17h3m-3 0v-3m0 3 3.5-3.5M7 7h3M7 7v3m0-3 3.5 3.5M17 17h-3m3 0v-3m0 3-3.5-3.5"/>
...
export function SquareFourArrowsOut({ variant = "linear", ...props }: IconProps) {
