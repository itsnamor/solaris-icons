...
const VARIANTS = {
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M6.31 12.75h8.19c.953 0 2.367-.28 3.563-1.141 1.235-.89 2.187-2.365 2.187-4.609a.75.75 0 0 0-1.5 0c0 1.756-.715 2.78-1.563 3.391-.887.639-1.974.859-2.687.859H6.31l-.75.75zm-2.503-.463"
        opacity=".5"
      />
    </>
  ),
...
ArrowBendDownLeft.displayName = "IconArrowBendDownLeft";
