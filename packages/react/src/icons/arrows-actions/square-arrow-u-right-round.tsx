...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17.5 9.5H9.962a3.462 3.462 0 1 0 0 6.923H14.5m3-6.923-2.25-2.077M17.5 9.5l-2.25 2.077"/>
		</>
	),
	bold: (
	...
	outline: (
		<><path fill="currentColor" d="M15.759 6.873a.75.75 0 1 0-1.018 1.102l.84.776h-5.62a4.212 4.212 0 1 0 0 8.423H14.5a.75.75 0 0 0 0-1.5H9.962a2.712 2.712 0 1 1 0-5.423h5.62l-.84.776a.75.75 0 1 0 1.017 1.102l2.25-2.077a.75.75 0 0 0 0-1.102z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M14.699 6.915a.75.75 0 0 1 1.06-.043l2.25 2.077a.75.75 0 0 1 0 1.102l-2.25 2.077a.75.75 0 0 1-1.018-1.102l.84-.776h-5.62a2.712 2.712 0 1 0 0 5.423H14.5a.75.75 0 0 1 0 1.5H9.962a4.211 4.211 0 1 1 0-8.423h5.62l-.84-.776a.75.75 0 0 1-.043-1.06" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
...
export function SquareArrowURightRound({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconSquareArrowURightRound = SquareArrowURightRound;
export const SquareArrowURightRoundIcon = SquareArrowURightRound;
