...
const VARIANTS = {
  ...
  outline: (
    <>
      <path
        fill="currentColor"
        d="M6.47 17.53a.75.75 0 0 1 0-1.06l2.22-2.22H7.5a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-1.19l-2.22 2.22a.75.75 0 0 1-1.06 0m10.03-6.28a.75.75 0 0 0 0-1.5h-1.19l2.22-2.22a.75.75 0 0 0-1.06-1.06l-2.22 2.22V7.5a.75.75 0 0 0-1.5 0v3c0 .414.336.75.75.75z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M6.47 17.53a.75.75 0 0 1 0-1.06l2.22-2.22H7.5a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-1.19l-2.22 2.22a.75.75 0 0 1-1.06 0m10.78-7.03a.75.75 0 0 1-.75.75h-3a.75.75 0 0 1-.75-.75v-3a.75.75 0 0 1 1.5 0v1.19l2.22-2.22a.75.75 0 1 1 1.06 1.06l-2.22 2.22h1.19a.75.75 0 0 1 .75.75"
        clipRule="evenodd"
      />
    </>
  ),
...
export function SquareArrowsSubDiagInShort({
  variant = "linear",
  ...props
}: IconProps) {
...
SquareArrowsSubDiagInShort.displayName = "IconSquareArrowsSubDiagInShort";
