...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6.5 9.5h7.539a3.462 3.462 0 0 1 0 6.923H9.5M6.5 9.5l2.25-2.077M6.5 9.5l2.25 2.077"/>
	...
	outline: (
		<><path fill="currentColor" d="M9.259 7.974A.75.75 0 1 0 8.24 6.872L5.99 8.949a.75.75 0 0 0 0 1.102l2.25 2.077a.75.75 0 1 0 1.018-1.102l-.84-.776h5.62a2.712 2.712 0 0 1 0 5.423H9.5a.75.75 0 1 0 0 1.5h4.539a4.212 4.212 0 0 0 0-8.423h-5.62z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M9.301 6.915a.75.75 0 0 1-.042 1.06l-.84.775h5.62a4.212 4.212 0 0 1 0 8.423H9.5a.75.75 0 1 1 0-1.5h4.539a2.712 2.712 0 0 0 0-5.423h-5.62l.84.776a.75.75 0 1 1-1.018 1.102l-2.25-2.077a.75.75 0 0 1 0-1.102l2.25-2.077a.75.75 0 0 1 1.06.043" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6.5 9.5h7.539a3.462 3.462 0 0 1 0 6.923H9.5M6.5 9.5l2.25-2.077M6.5 9.5l2.25 2.077"/>
...
export function SquareArrowULeftRound({ variant = "linear", ...props }: IconProps) {
