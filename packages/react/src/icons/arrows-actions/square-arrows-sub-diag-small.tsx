  ...
  broken: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M2 12c0 4.714 0 7.07 1.465 8.535 1.464 1.464 3.821 1.464 8.535 1.464s7.071 0 8.536-1.464c1.357-1.357 1.456-3.48 1.463-7.536M11 2c-4.055.007-6.178.107-7.535 1.464C2.648 4.28 2.287 5.374 2.127 7"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
...
function SquareArrowsSubDiagSmall({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

SquareArrowsSubDiagSmall.displayName = "IconSquareArrowsSubDiagSmall";

export const IconSquareArrowsSubDiagSmall = SquareArrowsSubDiagSmall;
export const SquareArrowsSubDiagSmallIcon = SquareArrowsSubDiagSmall;
