...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8.5 7v7m0 0 2.5-3m-2.5 3L6 11m9.5-4v7m0 0 2.5-3m-2.5 3L13 11"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M18 17H6"/>
	...
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8.5 7v7m0 0 2.5-3m-2.5 3L6 11m9.5-4v7m0 0 2.5-3m-2.5 3L13 11"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M18 17H6m16-5c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536"/>
		</>
	),
	outline: (
...
export function SquareArrowsDownToLine({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconSquareArrowsDownToLine = SquareArrowsDownToLine;
export const SquareArrowsDownToLineIcon = SquareArrowsDownToLine;
