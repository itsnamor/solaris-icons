...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M8 10h8m-8 4h5"/>
		</>
	),
	bold: (
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M7.25 10A.75.75 0 0 1 8 9.25h8a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75m0 4a.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
...
export function Document({ variant = "linear", ...props }: IconProps) {
