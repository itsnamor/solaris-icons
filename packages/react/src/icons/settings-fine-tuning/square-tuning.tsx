  ...
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M8 14v5m8-9V5M8 5v1m8 13v-1m6-6c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536"
      />
    </>
  ),
  outline: (
    <>
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M5.25 10a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M8 8.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5m8 8a2.75 2.75 0 1 1 0-5.5 2.75 2.75 0 0 1 0 5.5M14.75 14a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
