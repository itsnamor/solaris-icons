  ...
  bold: (
    <>
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M2 6.634a4.634 4.634 0 1 1 9.268 0 4.634 4.634 0 0 1-9.268 0m10.732 10.732a4.634 4.634 0 1 1 9.268 0 4.634 4.634 0 0 1-9.268 0"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
  ...
  broken: (
    <>
      ...
      <path
        stroke="currentColor"
        strokeWidth="1.5"
        d="M2.5 17.5c0-1.886 0-2.828.586-3.414S4.614 13.5 6.5 13.5s2.828 0 3.414.586.586 1.528.586 3.414 0 2.828-.586 3.414-1.528.586-3.414.586-2.828 0-3.414-.586S2.5 19.386 2.5 17.5Zm11-11c0-1.886 0-2.828.586-3.414S15.614 2.5 17.5 2.5s2.828 0 3.414.586.586 1.528.586 3.414 0 2.828-.586 3.414-1.528.586-3.414.586-2.828 0-3.414-.586S13.5 8.386 13.5 6.5Z"
      />
    </>
  ),
  outline: (
