...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M7 10.75a.75.75 0 0 1-.493-1.315l3.437-3a.75.75 0 0 1 .987 1.13L9 9.25h8a.75.75 0 0 1 0 1.5zm6.07 5.685a.75.75 0 0 0 .986 1.13l3.437-3A.75.75 0 0 0 17 13.25H7a.75.75 0 0 0 0 1.5h8z"/>
		</>
	),
	"line-duotone": (
...
export function SquareArrowsLeftRightMerge({ variant = "linear", ...props }: IconProps) {
