...
const VARIANTS = {
  ...
  broken: (
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="1.5"
      d="M9.5 4 4 10h10m6 0h-2.5m-3 10 5.5-6H10m-6 0h2.5"
    />
  ),
  outline: (
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M10.007 3.447a.75.75 0 0 1 .046 1.06L5.705 9.25H20a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1-.553-1.257l5.5-6a.75.75 0 0 1 1.06-.046m10.68 10.251A.75.75 0 0 0 20 13.25H4a.75.75 0 0 0 0 1.5h14.295l-4.348 4.743a.75.75 0 0 0 1.106 1.014l5.5-6a.75.75 0 0 0 .133-.809"
      clipRule="evenodd"
    />
  ),
  "bold-duotone": (
