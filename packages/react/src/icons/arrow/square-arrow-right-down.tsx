...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M15.579 14.828a.75.75 0 0 1-.75.75h-4.243a.75.75 0 1 1 0-1.5h2.432L8.64 9.702a.75.75 0 0 1 1.061-1.06l4.377 4.376v-2.432a.75.75 0 0 1 1.5 0z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m9 9 6 6m0 0v-4.5m0 4.5h-4.5"/>
...
export function SquareArrowRightDown({ variant = "linear", ...props }: IconProps) {
