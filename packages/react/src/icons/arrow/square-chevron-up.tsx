...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M14.47 14.03a.75.75 0 1 0 1.06-1.06l-3-3a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06L12 11.56z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m15 13.5-3-3-3 3"/>
...
export function SquareChevronUp({ variant = "linear", ...props }: IconProps) {
