...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M11.255 11.445a.75.75 0 0 1-1.01 1.11l-2.75-2.5a.75.75 0 0 1 0-1.11l2.75-2.5a.75.75 0 0 1 1.01 1.11L9.94 8.75H16a.75.75 0 0 1 0 1.5H9.94z"/>
		<path fill="currentColor" d="M12.746 16.445a.75.75 0 1 0 1.008 1.11l2.75-2.5a.75.75 0 0 0 0-1.11l-2.75-2.5a.75.75 0 1 0-1.008 1.11l1.314 1.195H8a.75.75 0 0 0 0 1.5h6.06z"/>
		</>
	),
	"line-duotone": (
...
export function SquareArrowsLeftRight({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconSquareArrowsLeftRight = SquareArrowsLeftRight;
export const SquareArrowsLeftRightIcon = SquareArrowsLeftRight;
