...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M13.25 7a.75.75 0 0 1 1.315-.493l3 3.437a.75.75 0 0 1-1.13.987L14.75 9v8a.75.75 0 0 1-1.5 0zm-5.685 6.07a.75.75 0 1 0-1.13.986l3 3.437A.75.75 0 0 0 10.75 17V7a.75.75 0 0 0-1.5 0v8z"/>
		</>
	),
	"line-duotone": (
...
export function SquareArrowsUpDownMerge({ variant = "linear", ...props }: IconProps) {
