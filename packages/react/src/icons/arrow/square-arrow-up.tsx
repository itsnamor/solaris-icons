...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M12.75 16a.75.75 0 0 1-1.5 0V9.81l-1.72 1.72a.75.75 0 0 1-1.06-1.06l3-3a.75.75 0 0 1 1.06 0l3 3a.75.75 0 1 1-1.06 1.06l-1.72-1.72z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 16V8m0 0 3 3m-3-3-3 3"/>
...
export function SquareArrowUp({ variant = "linear", ...props }: IconProps) {
