...
const VARIANTS = {
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="m12.518 17.18-1.061 1.06-1.3-1.301a.75.75 0 1 1 1.06-1.06zm3.209-3.21-1.06 1.06-1.301-1.3a.75.75 0 0 1 1.06-1.06zm3.199-3.2-1.06 1.061-1.301-1.3a.75.75 0 1 1 1.06-1.061z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
