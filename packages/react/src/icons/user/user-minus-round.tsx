...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M15.584 20.437C14.536 20.794 13.31 21 12 21c-3.866 0-7-1.79-7-4s3.134-4 7-4c2.608 0 4.883.815 6.088 2.024m2.326 3.476h-2.828"
      />
    </>
  ),
  bold: (
    <>
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M16.836 18.5a.75.75 0 0 1 .75-.75h2.828a.75.75 0 0 1 0 1.5h-2.828a.75.75 0 0 1-.75-.75"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="M18.877 16.25h-1.291a2.25 2.25 0 0 0-1.444 3.976C14.982 20.713 13.55 21 12 21c-3.866 0-7-1.79-7-4s3.134-4 7-4c3.417 0 6.262 1.399 6.877 3.249"
      />
    </>
  ),
  broken: (
  ...
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M17.586 17.75a.75.75 0 0 0 0 1.5h2.828a.75.75 0 0 0 0-1.5z"
      />
    </>
  ),
  "bold-duotone": (
