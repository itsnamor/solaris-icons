...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M21 10h-4"/>
		</>
	),
	bold: (
		<path fill="currentColor" d="M14 6a4 4 0 1 1-8 0 4 4 0 0 1 8 0m-4 7c4.418 0 8 2.015 8 4.5s0 4.5-8 4.5-8-2.015-8-4.5S5.582 13 10 13m7-3.75a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z"/>
	),
	broken: (
		<><circle cx="10" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M21 10h-4m.998 8q.002-.246.002-.5c0-2.485-3.582-4.5-8-4.5s-8 2.015-8 4.5S2 22 10 22c2.231 0 3.84-.157 5-.437"/>
		</>
	),
	outline: (
		...
		<path fill="currentColor" d="M17 9.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z"/>
		</>
	),
	"bold-duotone": (
...
export function UserMinus({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconUserMinus = UserMinus;
