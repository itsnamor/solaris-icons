...
const VARIANTS = {
  ...
  bold: (
    <path
      fill="currentColor"
      d="M14 6a4 4 0 1 1-8 0 4 4 0 0 1 8 0m-4 7c4.418 0 8 2.015 8 4.5s0 4.5-8 4.5-8-2.015-8-4.5S5.582 13 10 13m7-3.75a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z"
    />
  ),
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M21 10h-4m.998 8q.002-.246.002-.5c0-2.485-3.582-4.5-8-4.5s-8 2.015-8 4.5S2 22 10 22c2.231 0 3.84-.157 5-.437"
      />
    </>
  ),
  outline: (
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M13.513 21.487C14.025 22 14.85 22 16.5 22s2.475 0 2.987-.513C20 20.975 20 20.15 20 18.5s0-2.475-.513-2.987C18.975 15 18.15 15 16.5 15s-2.475 0-2.987.513C13 16.025 13 16.85 13 18.5s0 2.475.513 2.987m2.404-3.57h-.973a.583.583 0 1 0 0 1.166h3.112a.583.583 0 1 0 0-1.166z"
        clipRule="evenodd"
      />
    </>
  ),
