...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M8 13h8m-8 0v5c0 1.886 0 2.828.586 3.414S10.114 22 12 22s2.828 0 3.414-.586S16 19.886 16 18v-5m-8 0a7.46 7.46 0 0 1-5.618-5.472L2 6m14 7c1.71 0 3.15 1.28 3.35 2.98L20 21.5"/>
	...
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M8 13h8c1.71 0 3.15 1.28 3.35 2.98L20 21.5M8 13a7.46 7.46 0 0 1-5.618-5.472L2 6m6 7v5c0 1.886 0 2.828.586 3.414S10.114 22 12 22s2.828 0 3.414-.586S16 19.886 16 18v-1"/>
		<circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"/>
		</>
	),
	outline: (
	...
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m20 21.5-.65-5.52C19.15 14.28 17.71 13 16 13H8c-3 0-4.933-2.731-5.618-5.472L2 6"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M8 13v5c0 1.886 0 2.828.586 3.414S10.114 22 12 22s2.828 0 3.414-.586S16 19.886 16 18v-5" opacity=".5"/>
		<circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5" opacity=".9"/>
		</>
	),
};
