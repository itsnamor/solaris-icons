  ...
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M20.414 11.414 19 10m0 0-1.414-1.414M19 10l1.414-1.414M19 10l-1.414 1.414"
      />
    </>
  ),
  bold: (
    <path
      fill="currentColor"
      d="M14 6a4 4 0 1 1-8 0 4 4 0 0 1 8 0m4 11.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S5.582 13 10 13s8 2.015 8 4.5m2.945-8.384a.75.75 0 1 0-1.061-1.06L19 8.94l-.884-.884a.75.75 0 0 0-1.06 1.06l.883.884-.883.884a.75.75 0 0 0 1.06 1.06l.884-.883.884.884a.75.75 0 0 0 1.06-1.061L20.062 10z"
    />
  ),
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M20.414 11.414 19 10m0 0-1.414-1.414M19 10l1.414-1.414M19 10l-1.414 1.414M17.998 18q.002-.246.002-.5c0-2.485-3.582-4.5-8-4.5s-8 2.015-8 4.5S2 22 10 22c2.231 0 3.84-.157 5-.437"
      />
    </>
  ),
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M20.945 9.116a.75.75 0 1 0-1.061-1.06L19 8.94l-.884-.884a.75.75 0 0 0-1.06 1.06l.883.884-.884.884a.75.75 0 0 0 1.061 1.06l.884-.883.884.884a.75.75 0 0 0 1.06-1.061L20.062 10z"
      />
    </>
  ),
  "bold-duotone": (
...
export function UserX({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

UserX.displayName = "IconUserX";
