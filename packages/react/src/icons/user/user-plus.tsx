...
const VARIANTS = {
  ...
  bold: (
    <>
      ...
      <path
        fill="currentColor"
        d="M18 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S5.582 13 10 13s8 2.015 8 4.5"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M19.75 8a.75.75 0 0 0-1.5 0v1.25H17a.75.75 0 0 0 0 1.5h1.25V12a.75.75 0 0 0 1.5 0v-1.25H21a.75.75 0 0 0 0-1.5h-1.25z"
      />
    </>
  ),
  "bold-duotone": (
...
function UserPlus({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

UserPlus.displayName = "IconUserPlus";
