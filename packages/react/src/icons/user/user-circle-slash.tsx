  ...
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M15.5 13.535C14.47 13.195 13.275 13 12 13c-3.866 0-7 1.79-7 4s0 4 7 4q.525 0 1-.013m6.95-3.937-3.9 3.9"
      />
  ...
  bold: (
    <>
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M18 15.75a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5M16.25 19a1.75 1.75 0 0 1 2.338-1.649l-2.237 2.237A1.8 1.8 0 0 1 16.25 19m1.162 1.649 2.237-2.237q.1.277.101.588a1.75 1.75 0 0 1-2.338 1.649"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="M12 22c-8 0-8-2.015-8-4.5S7.582 13 12 13c2.37 0 4.498.58 5.963 1.5a4.5 4.5 0 0 0-3.392 7.414C13.82 21.97 12.97 22 12 22"
      />
    </>
  ),
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M15.5 13.535C14.47 13.195 13.275 13 12 13c-3.866 0-7 1.79-7 4 0 .345 0 .68.027 1M13 20.987Q12.525 21 12 21c-1.722 0-3.02-.108-4-.305m11.95-3.645-3.9 3.9"
      />
      <circle cx="18" cy="19" r="3" stroke="currentColor" strokeWidth="1.5" />
    </>
  ),
  ...
  "line-duotone": (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M15.5 13.535C14.47 13.195 13.275 13 12 13c-3.866 0-7 1.79-7 4s0 4 7 4q.525 0 1-.013"
        opacity=".5"
      />
      <path
        stroke="currentColor"
