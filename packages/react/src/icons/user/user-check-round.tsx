...
const VARIANTS = {
  ...
  bold: (
    <>
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M21.469 16.414a.75.75 0 0 1 .117 1.054l-2 2.5a.75.75 0 0 1-1.116.062l-1-1a.75.75 0 0 1 1.06-1.06l.407.407 1.477-1.845a.75.75 0 0 1 1.054-.118"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="m18.827 16.114-.184.23a2.25 2.25 0 0 0-2.234 3.747l.012.012C15.215 20.664 13.677 21 12 21c-3.866 0-7-1.79-7-4s3.134-4 7-4c3.332 0 6.12 1.33 6.827 3.113"
      />
    </>
  ),
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M12 13c2.608 0 4.883.815 6.088 2.024m-2.504 5.413C14.536 20.794 13.31 21 12 21c-3.866 0-7-1.79-7-4 0-1.36 1.187-2.56 3-3.283"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M21.586 17.469a.75.75 0 0 0-1.172-.937l-1.476 1.845-.054-.053-.354-.354a.75.75 0 1 0-1.06 1.06l1 1a.75.75 0 0 0 1.116-.062z"
      />
    </>
  ),
  "bold-duotone": (
