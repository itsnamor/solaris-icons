...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        stroke="currentColor"
        strokeWidth="1.5"
        d="M19 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S6.582 13 11 13s8 2.015 8 4.5Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  bold: (
    <path
      fill="currentColor"
      d="M15 6a4 4 0 1 1-8 0 4 4 0 0 1 8 0m4 11.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S6.582 13 11 13s8 2.015 8 4.5m2.56-8.502a.75.75 0 0 0-1.12-.996l-2.166 2.436-.772-.695a.75.75 0 1 0-1.004 1.114l1.334 1.2a.75.75 0 0 0 1.062-.059z"
    />
  ),
  broken: (
    <>
...
function UserCheck({ variant = "linear", ...props }: IconProps) {
