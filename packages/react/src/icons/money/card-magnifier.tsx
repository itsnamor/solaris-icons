...
const VARIANTS = {
  linear: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M22 13v-1c0-3.771 0-5.657-1.172-6.828S17.771 4 14 4h-4C6.229 4 4.343 4 3.172 5.172S2 8.229 2 12s0 5.657 1.172 6.828S6.229 20 10 20h3m-3-4H6m-4-6h20"
      />
  ...
  bold: (
    <>
      ...
      <path
        fill="currentColor"
        d="M10 4h4c3.771 0 5.657 0 6.828 1.172.844.843 1.08 2.057 1.146 4.078H2.026c.066-2.021.302-3.235 1.146-4.078C4.343 4 6.229 4 10 4m0 16h3.627a5.25 5.25 0 1 1 8.369-6.34Q22 12.9 22 12q0-.662-.002-1.25H2.002Q1.999 11.338 2 12c0 3.771 0 5.657 1.172 6.828S6.229 20 10 20"
      />
      <path
        fill="currentColor"
...
function CardMagnifier({ variant = "linear", ...props }: IconProps) {
