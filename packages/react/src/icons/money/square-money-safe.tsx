...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M6 7v10"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M11 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M16.5 9.5 18 8m-8 8 1.5-1.5m0-5L10 8m8 8-1.5-1.5"/>
		</>
	),
	bold: (
		<><path fill="currentColor" d="M11.75 12a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0"/>
	...
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M6 7v1m0 9v-5"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M11 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M12.5 9.401a3 3 0 1 1-1.099 1.099m5.099-1L18 8m-8 8 1.5-1.5m0-5L10 8m8 8-1.5-1.5"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M9.47 7.47a.75.75 0 0 1 1.06 0l1.402 1.401A3.73 3.73 0 0 1 14 8.25c.764 0 1.475.229 2.068.621L17.47 7.47a.75.75 0 1 1 1.06 1.06l-1.4 1.402c.392.593.621 1.304.621 2.068s-.229 1.475-.621 2.068l1.401 1.402a.75.75 0 1 1-1.06 1.06l-1.402-1.401A3.73 3.73 0 0 1 14 15.75a3.73 3.73 0 0 1-2.068-.621L10.53 16.53a.75.75 0 1 1-1.06-1.06l1.401-1.402A3.73 3.73 0 0 1 10.25 12c0-.764.229-1.475.621-2.068L9.47 8.53a.75.75 0 0 1 0-1.06M11.75 12a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeWidth="1.5" d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M6 7v10" opacity=".5"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M11 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M16.5 9.5 18 8m-8 8 1.5-1.5m0-5L10 8m8 8-1.5-1.5" opacity=".5"/>
		</>
	),
};
...
export const IconSquareMoneySafe = SquareMoneySafe;
export const SquareMoneySafeIcon = SquareMoneySafe;
