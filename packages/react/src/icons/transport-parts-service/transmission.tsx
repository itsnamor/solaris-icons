...
const VARIANTS = {
  linear: (
    <>
      <path
        stroke="currentColor"
        strokeWidth="1.5"
        d="M6 4a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm0 16a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm8 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm0-16a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm8 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M4 6v12m8-12v12m8-12v2c0 1.886 0 2.828-.586 3.414S17.886 12 16 12H4"
      />
      <path
        fill="currentColor"
  ...
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M12 6v7m0 5v-2m-8 2v-7m0-5v2m16-2v2c0 1.886 0 2.828-.586 3.414S17.886 12 16 12h-6m-6 0h2"
      />
      <path
        fill="currentColor"
        d="M18 15v-.75a.75.75 0 0 0-.75.75zm-.75 7a.75.75 0 0 0 1.5 0zm4.11.392a.75.75 0 1 0 1.28-.784zM18 15.75h2.286v-1.5H18zm.75 2.75V15h-1.5v3.5zm2.5-1.75c0 .567-.446 1-.964 1v1.5c1.375 0 2.464-1.134 2.464-2.5zm-.964-1c.518 0 .964.433.964 1h1.5c0-1.366-1.089-2.5-2.464-2.5zm0 2h-.429v1.5h.429zm-.429 0H18v1.5h1.857zm-.64 1.142 2.143 3.5 1.28-.784-2.143-3.5zM17.25 18.5V22h1.5v-3.5z"
  ...
  outline: (
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M4 2.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5M1.25 4a2.75 2.75 0 1 1 3.5 2.646v4.604h6.5V6.646a2.751 2.751 0 1 1 1.5 0v4.604H16c.964 0 1.612-.002 2.095-.066.461-.063.659-.17.789-.3s.237-.328.3-.79c.064-.482.066-1.13.066-2.094V6.646a2.751 2.751 0 1 1 1.5 0v1.406c0 .898 0 1.648-.08 2.242-.084.628-.27 1.195-.726 1.65-.455.456-1.022.642-1.65.726-.594.08-1.343.08-2.242.08H12.75v4.604a2.751 2.751 0 1 1-1.5 0V12.75h-6.5v4.604a2.751 2.751 0 1 1-1.5 0V6.646A2.75 2.75 0 0 1 1.25 4M12 2.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5m8 0a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5M17.25 15a.75.75 0 0 1 .75-.75h2.286c1.375 0 2.464 1.134 2.464 2.5a2.5 2.5 0 0 1-1.641 2.358l1.53 2.5a.75.75 0 1 1-1.279.784l-1.923-3.142h-.687V22a.75.75 0 0 1-1.5 0zm1.5 2.75h1.536c.518 0 .964-.433.964-1s-.446-1-.964-1H18.75zM4 18.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5m8 0a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5"
      clipRule="evenodd"
    />
  ),
  "bold-duotone": (
