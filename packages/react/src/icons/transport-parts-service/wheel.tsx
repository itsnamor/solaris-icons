  ...
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M6 12h4m4 0h4m-9 5.196 2-3.464m2-3.464 2-3.464m0 10.392-2-3.464m-2-3.464L9 6.804"
      />
    </>
  ),
  bold: (
  ...
  broken: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M6 12h4m4 0h4m-9 5.196 2-3.464m2-3.464 2-3.464m0 10.392-2-3.464m-2-3.464L9 6.804M7 3.338A9.95 9.95 0 0 1 12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12c0-1.821.487-3.53 1.338-5"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  "bold-duotone": (
    <>
      <g fill="currentColor" opacity=".5">
        ...
        <path
          fillRule="evenodd"
          d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10m-10 6a6 6 0 1 0 0-12 6 6 0 0 0 0 12m3-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"
          clipRule="evenodd"
        />
      </g>
      <path
...
function Wheel({ variant = "linear", ...props }: IconProps) {
