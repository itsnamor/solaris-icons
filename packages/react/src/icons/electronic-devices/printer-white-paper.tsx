...
const VARIANTS = {
  ...
  broken: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M22 12c0 2.828 0 4.243-.879 5.121-.641.642-1.567.815-3.121.862m-12 0c-1.553-.047-2.48-.22-3.121-.862C2 16.243 2 14.828 2 12s0-4.243.879-5.121C3.757 6 5.172 6 8 6h8c2.828 0 4.243 0 5.121.879.3.3.498.662.628 1.121M9 10H6m13 5H5"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M9 10.75a.75.75 0 0 0 0-1.5H6a.75.75 0 0 0 0 1.5zm9-.75a1 1 0 1 1-2 0 1 1 0 0 1 2 0"
      />
    </>
  ),
  "line-duotone": (
...
export function PrinterWhitePaper({ variant = "linear", ...props }: IconProps) {
