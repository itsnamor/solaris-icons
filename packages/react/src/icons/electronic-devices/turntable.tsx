...
const VARIANTS = {
  ...
  bold: (
    <>
      <path
        fill="currentColor"
        d="M16.25 9a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0m-9.5 3a3.25 3.25 0 1 1 6.5 0 3.25 3.25 0 0 1-6.5 0"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
  ...
  outline: (
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M9.932 1.25h4.136c1.828 0 3.294 0 4.445.193 1.208.203 2.165.633 2.901 1.553.717.896 1.033 2.019 1.185 3.437.151 1.402.151 3.203.151 5.52v.094c0 2.317 0 4.118-.15 5.52-.153 1.418-.47 2.541-1.186 3.437-.736.92-1.693 1.35-2.9 1.553-1.152.193-2.618.193-4.446.193H9.932c-1.828 0-3.294 0-4.445-.193-1.208-.203-2.165-.633-2.901-1.553-.717-.896-1.033-2.019-1.185-3.437-.151-1.402-.151-3.203-.151-5.52v-.094c0-2.317 0-4.118.15-5.52.153-1.418.47-2.541 1.186-3.437.736-.92 1.693-1.35 2.9-1.553 1.152-.193 2.618-.193 4.446-.193M5.735 2.923c-.97.163-1.542.465-1.978 1.01-.455.569-.725 1.356-.865 2.66C2.751 7.907 2.75 9.627 2.75 12s.001 4.094.142 5.406c.14 1.305.41 2.092.865 2.661.436.545 1.007.847 1.978 1.01 1.013.17 2.353.173 4.265.173h4c1.912 0 3.252-.003 4.265-.173.97-.163 1.542-.465 1.978-1.01.455-.569.725-1.356.865-2.66.141-1.313.142-3.033.142-5.407s-.001-4.094-.142-5.406c-.14-1.305-.41-2.092-.865-2.661-.436-.545-1.007-.847-1.978-1.01-1.013-.17-2.353-.173-4.265-.173h-4c-1.912 0-3.252.002-4.265.173M14.75 9a2.25 2.25 0 1 1 3 2.122v3.642a2.75 2.75 0 0 1-1.52 2.46l-.895.447a.75.75 0 1 1-.67-1.342l.894-.447a1.25 1.25 0 0 0 .691-1.118v-3.642A2.25 2.25 0 0 1 14.75 9M17 8.25a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5M5.25 12a4.75 4.75 0 1 1 9.5 0 4.75 4.75 0 0 1-9.5 0M10 8.75a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5"
      clipRule="evenodd"
    />
  ),
  "bold-duotone": (
