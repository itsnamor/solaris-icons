...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        fill="currentColor"
        d="M11.25 17.5a.75.75 0 0 0 1.5 0zm0-2.5v2.5h1.5V15z"
      />
    </>
  ),
  bold: (
...
export function FolderSecure({ variant = "linear", ...props }: IconProps) {
