...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M7 18v-3m5 3v-6m5 6V9"/>
		</>
	),
	bold: (
	...
	broken: (
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M7 18v-3m5 3v-6m5 6V9m5 3c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536"/>
	),
	outline: (
		<><path fill="currentColor" d="M7.75 15a.75.75 0 0 0-1.5 0v3a.75.75 0 0 0 1.5 0zM12 11.25a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-1.5 0v-6a.75.75 0 0 1 .75-.75M17.75 9a.75.75 0 0 0-1.5 0v9a.75.75 0 0 0 1.5 0z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M7 14.25a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75m5-3a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-1.5 0v-6a.75.75 0 0 1 .75-.75m5-3a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75"/>
		</>
	),
	"line-duotone": (
...
export function SquareChartBarUp({ variant = "linear", ...props }: IconProps) {
