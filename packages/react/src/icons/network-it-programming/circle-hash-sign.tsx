...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M11.718 7.216a.75.75 0 0 0-1.436-.431l-.74 2.465H7a.75.75 0 0 0 0 1.5h2.092l-.75 2.5H6a.75.75 0 0 0 0 1.5h1.892l-.61 2.035a.75.75 0 1 0 1.436.43l.74-2.465h3.434l-.61 2.035a.75.75 0 1 0 1.436.43l.74-2.465H17a.75.75 0 0 0 0-1.5h-2.092l.75-2.5H18a.75.75 0 0 0 0-1.5h-1.892l.61-2.034a.75.75 0 0 0-1.436-.431l-.74 2.465h-3.434zm2.374 3.534-.75 2.5H9.908l.75-2.5z" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M11 7 8 17m8-10-3 10m5-7H7m10 4H6"/>
