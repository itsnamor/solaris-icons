  ...
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="m15.5 9 .172.172c1.333 1.333 2 2 2 2.828s-.667 1.495-2 2.828L15.5 15m-2.206-7.83L12 12l-1.294 4.83M8.5 9l-.172.172c-1.333 1.333-2 2-2 2.828s.667 1.495 2 2.828L8.5 15"
      />
    </>
  ),
  bold: (
...
export function CircleCode({ variant = "linear", ...props }: IconProps) {
  return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

CircleCode.displayName = "IconCircleCode";

export const IconCircleCode = CircleCode;
export const CircleCodeIcon = CircleCode;
