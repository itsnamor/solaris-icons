...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M13.294 7.17 12 12l-1.294 4.83"/>
		<circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5"/>
		</>
	),
	bold: (
		<path fill="currentColor" fillRule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10m2.018-14.635a.75.75 0 1 0-1.448-.389l-2.589 9.66a.75.75 0 0 0 1.45.388z" clipRule="evenodd"/>
	),
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M13.294 7.17 12 12l-1.294 4.83"/>
	...
	outline: (
		<><path fill="currentColor" d="M14.018 7.365a.75.75 0 1 0-1.449-.389l-2.588 9.66a.75.75 0 1 0 1.45.388z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M14.019 7.365a.75.75 0 0 0-1.449-.389l-2.588 9.66a.75.75 0 1 0 1.449.388z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M13.294 7.17 12 12l-1.294 4.83"/>
