...
const VARIANTS = {
  linear: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="m17 7.83 1.697 1.526c1.542 1.389 2.313 2.083 2.313 2.974 0 .89-.771 1.585-2.314 2.973L17 16.83M13.987 5 12 12.415l-1.987 7.415M7 7.83 5.304 9.356C3.76 10.745 2.99 11.44 2.99 12.33s.771 1.585 2.314 2.973L7 16.83"
    />
  ),
  bold: (
    <path
  ...
  broken: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="m17 7.83 1.697 1.526c1.542 1.389 2.313 2.083 2.313 2.974 0 .89-.771 1.585-2.314 2.973L17 16.83M13.987 5l-.994 3.707M11.843 13l-1.83 6.83M7 7.83 5.304 9.356C3.76 10.745 2.99 11.44 2.99 12.33s.771 1.585 2.314 2.973L7 16.83"
    />
  ),
  outline: (
    <path
  ...
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M14.181 4.276a.75.75 0 0 1 .53.918l-3.973 14.83a.75.75 0 1 1-1.45-.388l3.974-14.83a.75.75 0 0 1 .92-.53"
        opacity=".5"
      />
    </>
  ),
  "line-duotone": (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M7 7.83 5.304 9.356C3.76 10.745 2.99 11.44 2.99 12.33s.771 1.585 2.314 2.973L7 16.83"
      />
    </>
  ),
};

export function Code({ variant = "linear", ...props }: IconProps) {
