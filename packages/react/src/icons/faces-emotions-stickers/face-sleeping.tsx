...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2"/>
	...
	broken: (
		...
		<path fill="currentColor" d="M13 16a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
		<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m17 4 3.464-2L19 7.464l3.464-2m-8.416.036 1.732 1-2.732.732 1.732 1"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M22 12c0 5.523-4.477 10-10 10a9.96 9.96 0 0 1-5-1.338M12 2C6.477 2 2 6.477 2 12c0 1.821.487 3.53 1.338 5"/>
		</>
	),
	outline: (
		<><path fill="currentColor" d="M13 16a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
	...
	"bold-duotone": (
		<><path fill="currentColor" d="M11 23c5.523 0 10-4.477 10-10S16.523 3 11 3 1 7.477 1 13s4.477 10 10 10" opacity=".5"/>
		<path fill="currentColor" fillRule="evenodd" d="M16.375 4.65a.75.75 0 1 1-.75-1.3l3.464-2a.75.75 0 0 1 1.1.844l-.996 3.715 1.896-1.094a.75.75 0 1 1 .75 1.299l-3.464 2a.75.75 0 0 1-1.1-.844l.996-3.715zm-3.702 1.5a.75.75 0 1 1 .75-1.3l1.732 1a.75.75 0 0 1-.181 1.374l-.983.264.164.095a.75.75 0 1 1-.75 1.299l-1.732-1a.75.75 0 0 1 .18-1.374l.984-.264z" clipRule="evenodd"/>
