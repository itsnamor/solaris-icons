...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" fillRule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10m0-3a7 7 0 1 0 0-14 7 7 0 0 0 0 14" clipRule="evenodd"/>
		</>
	),
	"line-duotone": (
		<circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5"/>
