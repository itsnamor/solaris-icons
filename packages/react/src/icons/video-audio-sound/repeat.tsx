...
const VARIANTS = {
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M14.5 4.25a.75.75 0 0 0 0 1.5h.5a6.25 6.25 0 1 1 0 12.5h-2a.75.75 0 0 0-.53 1.28l2 2a.75.75 0 0 0 1.06-1.06l-.72-.72H15a7.75 7.75 0 0 0 0-15.5z" opacity=".5"/>
		</>
	),
	"line-duotone": (
...
export function Repeat({ variant = "linear", ...props }: IconProps) {
