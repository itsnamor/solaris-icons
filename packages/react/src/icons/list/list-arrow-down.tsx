...
const VARIANTS = {
	linear: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m15 17.5 2.5 2.5m0 0 2.5-2.5M17.5 20v-6"/>
	...
	broken: (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m15 17.5 2.5 2.5m0 0 2.5-2.5M17.5 20v-6"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M11 14H3m8 4H3M3 6h10.5M20 6h-2.25M20 10H9.5M3 10h2.25"/>
		</>
	),
	outline: (
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M17.5 13.25a.75.75 0 0 1 .75.75v4.19l1.22-1.22a.75.75 0 1 1 1.06 1.06l-2.5 2.5a.75.75 0 0 1-1.06 0l-2.5-2.5a.75.75 0 1 1 1.06-1.06l1.22 1.22V14a.75.75 0 0 1 .75-.75"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m15 17.5 2.5 2.5m0 0 2.5-2.5M17.5 20v-6"/>
...
export function ListArrowDown({ variant = "linear", ...props }: IconProps) {
	return <Icon {...props}>{VARIANTS[variant]}</Icon>;
}

export const IconListArrowDown = ListArrowDown;
export const ListArrowDownIcon = ListArrowDown;
