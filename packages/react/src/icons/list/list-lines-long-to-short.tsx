...
const VARIANTS = {
	linear: (
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M20 7H4m11 5H4m5 5H4"/>
	),
	bold: (
	...
	"line-duotone": (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M15 12H4" opacity=".7"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M9 17H4" opacity=".4"/>
		</>
	),
};

export function ListLinesLongToShort({ variant = "linear", ...props }: IconProps) {
