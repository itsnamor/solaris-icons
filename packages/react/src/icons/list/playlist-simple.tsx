  ...
  linear: (
    <>
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M20 6H3m7 10H3m7-5H3"
      />
      <path
        stroke="currentColor"
        strokeWidth="1.5"
        d="M19.125 10.685c1.642.948 2.463 1.422 2.723 2.05.203.49.203 1.04 0 1.53-.26.628-1.081 1.102-2.723 2.05s-2.463 1.422-3.136 1.333a2 2 0 0 1-1.326-.765c-.413-.539-.413-1.487-.413-3.383s0-2.844.413-3.383a2 2 0 0 1 1.326-.765c.673-.089 1.494.385 3.136 1.333Z"
      />
    </>
  ),
  bold: (
