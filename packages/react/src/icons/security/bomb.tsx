...
const VARIANTS = {
  linear: (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="m17 7-2 2m4.5-1.5 1 .5M16 3.5l.5 1M19 5l1-1"
      />
    </>
  ),
  bold: (
  ...
  broken: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="m17 7-2 2m4.5-1.5 1 .5M16 3.5l.5 1M19 5l1-1M5.75 8.003a7.5 7.5 0 1 1-2.747 2.747"
    />
  ),
  outline: (
    <>
      ...
      <path
        fill="currentColor"
        d="M19.835 6.83a.75.75 0 1 0-.67 1.34l1 .5a.75.75 0 1 0 .67-1.34zm.695-2.3a.75.75 0 0 0-1.06-1.06l-1 1a.75.75 0 0 0 1.06 1.06z"
      />
    </>
  ),
  "bold-duotone": (
    <>
      ...
      <path
        fill="currentColor"
        d="M16.67 3.165a.75.75 0 1 0-1.34.67l.5 1a.75.75 0 1 0 1.34-.67zm3.165 3.665a.75.75 0 1 0-.67 1.34l1 .5a.75.75 0 1 0 .67-1.34zm.695-2.3a.75.75 0 0 0-1.06-1.06l-1 1a.75.75 0 0 0 1.06 1.06zm-5.223 5.223L17.53 7.53a.75.75 0 0 0-1.06-1.06l-2.223 2.223q.583.478 1.06 1.06"
      />
    </>
  ),
  "line-duotone": (
...
function Bomb({ variant = "linear", ...props }: IconProps) {
