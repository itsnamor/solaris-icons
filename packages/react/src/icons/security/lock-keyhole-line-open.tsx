...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M6 10V8a6 6 0 0 1 11.811-1.5M12 14v4"/>
		</>
	),
	bold: (
	...
	broken: (
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M12 14v4m-1 4H8c-2.828 0-4.243 0-5.121-.879C2 20.243 2 18.828 2 16s0-4.243.879-5.121C3.757 10 5.172 10 8 10h8c2.828 0 4.243 0 5.121.879C22 11.757 22 13.172 22 16s0 4.243-.879 5.121C20.243 22 18.828 22 16 22h-1M6 10V8q0-.511.083-1m11.728-.5A6.003 6.003 0 0 0 7.528 4"/>
	),
	outline: (
		<><path fill="currentColor" d="M12.75 14a.75.75 0 0 0-1.5 0v4a.75.75 0 0 0 1.5 0z"/>
	...
	"bold-duotone": (
		...
		<path fill="currentColor" d="M12.75 14a.75.75 0 0 0-1.5 0v4a.75.75 0 0 0 1.5 0zm-6-6a5.25 5.25 0 0 1 10.335-1.313.75.75 0 0 0 1.452-.374A6.75 6.75 0 0 0 5.25 8v2.055a24 24 0 0 1 1.5-.051z"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeWidth="1.5" d="M2 16c0-2.828 0-4.243.879-5.121C3.757 10 5.172 10 8 10h8c2.828 0 4.243 0 5.121.879C22 11.757 22 13.172 22 16s0 4.243-.879 5.121C20.243 22 18.828 22 16 22H8c-2.828 0-4.243 0-5.121-.879C2 20.243 2 18.828 2 16Z"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M6 10V8a6 6 0 0 1 11.811-1.5M12 14v4" opacity=".5"/>
		</>
	),
};

export function LockKeyholeLineOpen({ variant = "linear", ...props }: IconProps) {
