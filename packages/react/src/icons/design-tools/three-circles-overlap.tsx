...
const VARIANTS = {
	linear: (
		...
		<path stroke="currentColor" strokeWidth="1.5" d="M6.5 10.189a6 6 0 1 0 7.106 3.669"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M12 20.472a6 6 0 1 0 5.5-10.283"/>
		</>
	),
	bold: (
		<><path fill="currentColor" d="M18 8A6 6 0 1 1 6 8a6 6 0 0 1 12 0"/>
		<path fill="currentColor" d="M5.033 10.783a6 6 0 1 0 8.92 4.46 7.503 7.503 0 0 1-8.92-4.46m10.354 3.911q.112.636.113 1.306c0 2.09-.855 3.982-2.235 5.342a6 6 0 0 0 5.702-10.558 7.53 7.53 0 0 1-3.58 3.91"/>
		</>
	),
	broken: (
		<><path stroke="currentColor" strokeWidth="1.5" d="M12 20.283A6 6 0 1 0 17.5 10"/>
		<path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M9 2.803A6 6 0 1 1 6.341 6"/>
	...
	"bold-duotone": (
		<><path fill="currentColor" d="M18 8A6 6 0 1 1 6 8a6 6 0 0 1 12 0"/>
		<path fill="currentColor" d="M13.58 13.79a6 6 0 0 1-7.16-3.58 6 6 0 1 0 7.16 3.58" opacity=".7"/>
		<path fill="currentColor" d="M13.58 13.79c.271.684.42 1.43.42 2.21a6 6 0 0 1-2 4.472 6 6 0 1 0 5.58-10.262 6.01 6.01 0 0 1-4 3.58" opacity=".4"/>
		</>
	),
	"line-duotone": (
		<><path stroke="currentColor" strokeWidth="1.5" d="M18 8A6 6 0 1 1 6 8a6 6 0 0 1 12 0Z"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M6.5 10.189a6 6 0 1 0 7.106 3.669"/>
		<path stroke="currentColor" strokeWidth="1.5" d="M12 20.472a6 6 0 1 0 5.5-10.283" opacity=".5"/>
		</>
	),
};

export function ThreeCirclesOverlap({ variant = "linear", ...props }: IconProps) {
