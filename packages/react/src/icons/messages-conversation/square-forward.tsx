  ...
  linear: (
    <>
      ...
      <path
        ...
        strokeWidth="1.5"
        d="m16.155 3.434 2.357 2.043c1.623 1.407 2.434 2.11 2.434 3.023s-.811 1.616-2.434 3.023l-2.357 2.043c-.714.618-1.07.927-1.363.794-.292-.134-.292-.606-.292-1.55v-1.524c-3 0-6.25 1.393-7.5 3.714 0-7.429 4.444-9.286 7.5-9.286V4.19c0-.944 0-1.416.292-1.55.293-.133.65.176 1.363.794"
      />
    </>
  ),
  bold: (
