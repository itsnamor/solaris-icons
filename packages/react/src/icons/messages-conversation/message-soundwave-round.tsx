...
const VARIANTS = {
  ...
  broken: (
    <path
      ...
      strokeLinecap="round"
      strokeWidth="1.5"
      d="M12 16V8m-4 6v-4m8 4v-4m1-6.662A9.95 9.95 0 0 0 12 2C6.477 2 2 6.477 2 12c0 1.6.376 3.112 1.043 4.453.178.356.237.763.134 1.148l-.595 2.226a1.3 1.3 0 0 0 1.591 1.592l2.226-.596a1.63 1.63 0 0 1 1.149.133A9.96 9.96 0 0 0 12 22c5.523 0 10-4.477 10-10 0-1.821-.487-3.53-1.338-5"
    />
  ),
  outline: (
    <path
